        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="w-full md:w-1/2" data-aos="fade-right" data-aos-delay="100">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 w-40 h-40 bg-primary rounded-xl flex items-center justify-center p-6 shadow-lg dark:bg-primary/20 backdrop-blur" data-aos="fade-up" data-aos-delay="300">
          ...
          <div className="w-full md:w-1/2" data-aos="fade-left" data-aos-delay="200">
            <h2 className="text-3xl md:text-4xl font-bold mb-6" data-aos="fade-up" data-aos-delay="100">About Me</h2>
